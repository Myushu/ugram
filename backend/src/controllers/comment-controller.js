...
module.exports = function(app) {
    ...
    app.post('/users/:userId/pictures/:pictureId/comment', (req, res) => {
      service.createComment(req.param('userId'), req.param('pictureId'), req.body, res);
    });

    // Delete a hashtag
    app.delete('/users/:userId/pictures/:pictureId/comment/:idComment', (req, res) => {
      service.deleteComment(req.param('userId'), req.param('pictureId'), req.param('idComment'), res);
    });
}
